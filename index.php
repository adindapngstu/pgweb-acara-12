            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped table-bordered">
                        <tr>
                            <th>Nama</th>
                            <td>Adinda Pangestu</td>
                        </tr>
                        <tr>
                            <th>NIM</th>
                            <td>23/517374/SV/22765</td>
                        </tr>
                        <tr>
                            <th>Kelas</th>
                            <td>A</td>
                        ...
                        <tr>
                            <th>GitHub</th>
                            <td><a href="https://github.com/adindapngstu" target="_blank"
                                    rel="noopener noreferrer">https://github.com/adindapngstu</a></td>
                        </tr>
                        </tr>
                    </table>
                </div>
...
<script>
    var map = L.map("map").setView([-7.7047944099032755, 110.3788361824491], 13);
    ...
    var wmsLayer1 = L.Geoserver.wms("http://localhost:8080/geoserver/wms", {
        layers: "pgweb12:ADMINISTRASIDESA_AR_25K",
        transparent: true,
    });
    wmsLayer1.addTo(map);
